...
リージョンごとにアップロードできる Lambda コードの合計サイズが決まっていました．
...
Lambda を触る場合は SAM のほうが圧倒的に楽ですが，現在の最新である [SAM version 1.163.0](https://github.com/aws/aws-sam-cli/releases/tag/v1.163.0) では，まだ Code storage mode を指定できなかったので，CFn で試します．

まず，従来の COPY モードで作成してみます．特筆すべきものはないですが，`template.yaml` は以下の通りです．

https://github.com/jjjsmz/playground/blob/lambda-managed-storage/aws/lambda-managed-storage/template.yaml#L1-L31
