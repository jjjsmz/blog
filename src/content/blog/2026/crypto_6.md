...
[第1章](/blog/2026/crypto_1)から[第5章](/blog/2026/crypto_5)まで解説してきた暗号技術が，**TLS (Transport Layer Security)** の中でどのように組み合わされているかを見ていきます．ブラウザが「この接続は保護されています」と言うとき，その裏側で起きていることが対象です．
...
<details>
<summary>☕ コラム: 鍵アイコンはもういない</summary>

Netscape の頃からアドレスバーの HTTPS の目印だった鍵アイコンは，Chrome 117 (2023 年 9 月) で **tune アイコン** (スライダー状のアイコン) に置き換えられました．Android でも同時に置き換えられ，iOS ではもともとタップできなかったため削除されています．

理由は，鍵アイコンが誤解されていたからです．Chrome セキュリティチームの[記事](https://blog.chromium.org/2023/05/an-update-on-lock-icon.html)によれば，[2021 年の調査](https://research.google/pubs/pub51481/) (1880 人が対象) で鍵アイコンの正確な意味を理解していた参加者は **11%** しかいませんでした．多くの人はこれを「このサイトは信頼できる」という意味に取っていたわけです．

本稿でここまで見てきたとおり，TLS が保証するのは**経路**です．盗聴されない，改ざんされない，相手は証明書どおりの相手である．そのサイトが善良かどうか，返ってくる中身が安全かどうかについては何も言っていません．
実際，フィッシングサイトはほぼすべて HTTPS であり，したがって鍵アイコンも表示されていました．FBI が「鍵アイコンや https があるというだけでサイトを信用するな」という[注意喚起](https://www.ic3.gov/PSA/2019/PSA190610)を出す事態にもなっています．

HTTPS が例外だった時代には，鍵は「この接続は特別に保護されている」という有益な合図でした．Chrome on Windows のページ読み込みの 95% 以上が HTTPS になった今では，わざわざ知らせる価値がありません．
なお鍵アイコンが消滅したわけではなく，tune アイコンから開くサイト設定の中に，接続のセキュリティ情報への入り口として残っています．平文の HTTP を「保護されていない通信」と表示する動作も従来どおりです．
